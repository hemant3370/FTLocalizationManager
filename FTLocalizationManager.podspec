...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Abdulla/FTLocalizationManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Abdulla' => 'abdulla@farabi.ae' }
  s.source           = { :git => 'https://github.com/Abdulla/FTLocalizationManager.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'FTLocalizationManager' => ['FTLocalizationManager/Assets/*.png']
  # }
